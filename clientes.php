  ...
  <br>
      <article>
        <center>
         <form action="">
           <h2>Clientes</h2>
           <input type="number" placeholder="Codigo Cliente" name="cod_cli">
           <input type="text" placeholder="Apellido Cliente" name="ape_cli">
           <input type="text" placeholder="Nombre Cliente" name="nom_cli">
           <input type="number" placeholder="Telefono Cliente" name="tel_cli">
           <input type="text" placeholder="Correo Cliente" name="cor_cli">

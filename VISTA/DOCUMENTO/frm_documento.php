...
<body>
  ...
  <br>
      <article>
        <center>
         <form action="../CONTROLADOR/control_documento.php" method="POST">
          <h2>Documento</h2>
          <!--<input type="number" placeholder="Codigo cargo" name="txcod_car">-->
          <input type="text" placeholder="Nombre Documento" name="txnom_doc">
        ...
        <div class="content">
           <hr>   
    <center> 
      <label>REPORTE DE DOCUMENTOS</label>
      <table>
        <thead>
          <tr>
          <th>CODIGO</th>
        ...
        ?>
          <td><?php echo $key['pkcod_doc'];//nombre campos bd?></td>
          <td><?php echo $key['nom_doc'];//nombre campos bd?></td>
          <td>
            <a href="../CONTROLADOR/control_documento.php?cod_act=<?php echo $key['pkcod_doc']?>"><img src="../imagenes/modificar.svg" class="img-fluid" alt="Responsive image" width="30px"></a>
          </td>
          <td>
            <a href="../CONTROLADOR/control_documento.php?cod_eli=<?php echo $key['pkcod_doc']?>z"><img src="../imagenes/eliminar.svg" class="img-fluid" alt="Responsive image" width="30px"></a>
          </td>
        </tr>
        <?php 
          }//cierre foreach

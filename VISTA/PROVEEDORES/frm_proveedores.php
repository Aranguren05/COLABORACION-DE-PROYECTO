      ...
      <article>
        <center>
         <form action="../CONTROLADOR/control_proveedores.php" method="POST">
          ...
          <input type="text" placeholder="Nombres" name="txnom_prov">
          <input type="text" placeholder="Apellidos" name="txape_prov">
          <input type="text" placeholder="Correo" name="txcor_prov">
        ...
        <div class="content">
           <hr>   
    <center> 
      <label>REPORTE DE PROVEEDORES</label>
      <table>
        <thead>
          <tr>
          <th>CODIGO</th>
        ...
        ?>
          ...
          <td>
            <a href="../CONTROLADOR/control_proveedores.php?cod_act=<?php echo $key['pkcod_prov']?>"><img src="../imagenes/modificar.svg" class="img-fluid" alt="Responsive image" width="30px"></a>
          </td>
          <td>
            <a href="../CONTROLADOR/control_proveedores.php?cod_eli=<?php echo $key['pkcod_prov']?>z"><img src="../imagenes/eliminar.svg" class="img-fluid" alt="Responsive image" width="30px"></a>
          </td>
        </tr>
        <?php 
          }//cierre foreach

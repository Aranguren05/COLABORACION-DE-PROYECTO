...
<body>
  ...
  <br>
      <article>
        <center>
         <form action="../CONTROLADOR/control_producto.php" method="POST">
          <h2>Productos</h2>
          <!--<input type="number" placeholder="Codigo cargo" name="txcod_car">-->
          <input type="text" placeholder="Nombre" name="txnom_pro">
          <input type="Number" placeholder="Precio" name="precio">
          <input type="text" placeholder="Descripcion" name="txdes_pro">
          <input type="text" placeholder="Tipo" name="txtipo_pro">
          <input type="number" placeholder="Proveedor" name="fkcod_prov">
        ...
        <div class="content">
           <hr>   
    <center> 
      <label>REPORTE DE PRODUCTOS</label>
      <table>
        <thead>
          <tr>
          <th>CODIGO</th>
        ...
        ?>
          <td><?php echo $key['pkcod_pro'];//nombre campos bd?></td>
          <td><?php echo $key['nom_pro'];//nombre campos bd?></td>
          <td><?php echo $key['precio_pro'];//nombre campos bd?></td>
          <td><?php echo $key['descripcion_pro'];//nombre campos bd?></td>
          <td><?php echo $key['tipo_pro'];//nombre campos bd?></td>

  ...
  ?>
    ...
    <section id="main-content">
		...
		<form action="../CONTROLADOR/control_devengado.php" method="POST">
             <h1>Actualizacion de Valor Devengado</h1>
            <!--Pasar el dato de la bd a una variable de php-->
            <?Php $ref = $res[0];?>
            
            
			<!--Mostrar el dato de la informacion en una caja de texto invisible-->
            <input type="hidden" name="txcod_dev" value="<?php echo $ref; ?>">
            <input type="hidden" name="tx_emp_dev" value="<?php echo $ref; ?>">
            <input type="hidden" name="fechai_dev" value="<?php echo $ref; ?>">
            <input type="hidden" name="fechaf_dev" value="<?php echo $ref; ?>">
            <input type="hidden" name="pagototal_dev" value="<?php echo $ref; ?>">
            ...
            <center>
		    	...
		    	<br>
			      ...
			      <p>Empleado</p>
            <input type="text" name="txemp_dev" value="<?php echo $res[1]?>">
            <p>Fecha Inicial</p>
            <input type="date" name="fechai_dev" value="<?php echo $res[1]?>">
            <p>Fecha Final</p>
            <input type="date" name="fechaf_dev" value="<?php echo $res[1]?>">
            <p>Pago Total</p>
            <input type="number" name="pagototal_dev" value="<?php echo $res[1]?>">

    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="navbar">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-lin" href="documento.php">Documento</a>
            </li>
             <li class="nav-item">
  ...
  <br>
      <article>
        <center>
         <form action="">
          <h2>Cargos</h2>
          <input type="number" placeholder="Codigo cargo" name="cod_car">
          <input type="text" placeholder="nombre cargo" name="nom_car">
          <input type="text" placeholder="sueldo" name="nom_car">

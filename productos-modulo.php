        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="productos_modulos.php">Productos</a>
            </li>
            <li class="nav-item">
  ...
  <br>
      <article>
        <center>
         <form action="">
           <h2>Productos</h2>
           <input type="number" placeholder="Codigo Producto" name="cod_cli">
           <input type="text" placeholder="Nombre Producto" name="nom_cli">
           <input type="text" placeholder="$Precio Producto" name="nom_cli">
           <input type="text" placeholder="Descripcion Producto" name="nom_cli">
           <input type="text" placeholder="tipo Producto" name="nom_cli">
